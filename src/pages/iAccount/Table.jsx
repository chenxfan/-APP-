            ...
            <React.Fragment>
                <div>
                    {this.state.tableData.map((item, i) => {
                        return (
                            <div className="infoList" style={{marginLeft:"20px"}}>
                                ...
                                <div className="infoState"><a>{this.state.isState?"停用":"启用"}</a></div>
                                <div className="infoAction">
                                    <UpdBanner data={item} allData={tableData} onUpdInfo={(e)=>{this.updInfo(e)}}/>
                                    <i></i>
                                    {/*<a onClick={(e)=>{this.changeState(e)}}>{this.state.isState?"启用":"停用"}</a>*/}
                                    <a>{this.state.isState?"启用":"停用"}</a>
                                    <i></i>
                ...
                <div style={{display:"flex",justifyContent:"flex-end",marginTop:"30px",marginBottom:"100px",marginRight:"100px"}}>
                    <Pagination
