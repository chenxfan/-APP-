                    ...
                    {this.state.tableData.map((item, i) => {
                        return (
                            <div className="commentList" key={i}>
                                <div className="cListImg">
                                    <img src={require("../../images/comment/comment-video/u1498.jpg")} />
                                </div>
                                <div className="cListName">
                                    <div>{item.name}</div>
                                    <div>{item.detail}</div>
                                </div>
                                ...
                                <div className="infoPath">
                                    <div>发布终端</div>
                                    <div><a>{item.phone}</a></div>
                                </div>
                                <div className="infoImg">
                                    <div>浏览器版本</div>
                                    <div><a>{item.brower}</a></div>
                                </div>
                                <div className="infoState"><a></a></div>
